...
def get_distance(
    ...
    if pilot_frac == 1.4:
        sims = {0.4 * total_sims, 0.6 * total_sims}
    else:
    ...
    if name == "Adaptive__Linear__Subset":
...
fracs = [0.0, 0.2, 0.3, 0.4, 0.5, 0.7, 1.4]
...
def type_to_problem(problem_type, **kwargs):
    ...
    if problem_type == "harrison_dimer":
        return slad.HarrisonDimerProblem(**kwargs)
    ...
    for i_rep in range(n_rep):
        for i_frac, frac in enumerate(fracs):
            ...
            if problem_type == "demo":
                ...
                pop_size = 2000
                max_total_sim = 40000
            elif problem_type == "harrison_dimer":
                pop_size = 2000
                max_total_sim = 40000
            else:
            ...
            for distance_name in distance_names:
                ...
                #if distance_name in ["PNorm", "Adaptive"] and i_frac > 0:
                #    continue
