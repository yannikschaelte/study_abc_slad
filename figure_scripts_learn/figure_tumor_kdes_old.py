...
distance_names = [
    ...
    "Adaptive__Linear__Manhattan__mad_or_cmad__Extend",
    "Adaptive__MS__Manhattan__mad_or_cmad__Extend",
    "Info__Linear__Manhattan__mad_or_cmad",
    #"Info__Linear__Manhattan__mad_or_cmad__Subset",
    "Info__Linear__Manhattan__mad_or_cmad__Extend",
    "Info__MS__Manhattan__mad_or_cmad__Extend",
]
...
for fmt in ["pdf", "png"]:
    plt.savefig(f"figures_learn/figure_tumor_kdes{hist_suf}.{fmt}", format=fmt, dpi=200)
